...
namespace App\Addons\TestNewAddon;
 ...
 * @version 1.0.0
 */
class TestNewAddon extends BasePlugin
{
    /**
     * 构造函数
     */
    ...
    {
        parent::__construct($hookManager);
    }
    
    /**
     * 插件名称
     */
    protected string $name = 'TestNewAddon';
    ...
    public function registerHooks(HookManager $hookManager): void
    {
        ...
        // 注册自定义钩子
        $hookManager->addAction('TestNewAddon.custom_action', [$this, 'handleCustomAction']);
    }
